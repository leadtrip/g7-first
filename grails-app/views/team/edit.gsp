...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#edit-team" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="edit-team" class="col-12 content scaffold-edit" role="main">
                ...
                <g:form resource="${this.team}" controller="${controllerName}" method="PUT">
